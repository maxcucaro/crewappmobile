...
const EventShiftCard: React.FC<EventShiftCardProps> = ({ report, onRectify }) => {
  ...
  const totalBenefits = timesheet?.total_benefits || 0;
  const hasAnyBenefits = totalBenefits > 0;
  ...
  const showExpectedBenefits = !isCompleted && (hasBonusPrevisti || hasBenefitsPrevisti || assignment.bonus_trasferta || assignment.bonus_diaria);
