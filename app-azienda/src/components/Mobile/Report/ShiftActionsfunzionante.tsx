...
const ShiftActions: React.FC<ShiftActionsProps> = ({ shift, onUpdate }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Se il turno non aveva un checkout (era ancora aperto), aggiorna anche check_out_time
    ...
    <div className="mt-3 bg-gray-800 border border-gray-600 rounded-lg p-4">
      ...
      {(!shift.original_check_out || shift.status !== 'completed') && (
        <div className="mb-4 bg-orange-900 bg-opacity-30 border border-orange-700 rounded-lg p-3">
          <div className="flex items-start space-x-2">
            ...
            <div>
              <div className="text-xs font-semibold text-orange-200 mb-1">⚠️ Turno Ancora Aperto</div>
      ...
      <div className="space-y-3 mb-3">
        <div className="bg-green-900 bg-opacity-20 border border-green-700 rounded-lg p-3 mb-3">
          <div className="text-xs font-semibold text-green-200 mb-3">✏️ Nuovi Orari Rettificati:</div>
