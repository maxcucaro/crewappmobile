/*
  # Fix tipo_giornata mapping in popola_dettaglio_giorno_semplice
  
  1. Changes
    - Map tipo_richiesta from crew_richiesteferie_permessi correctly:
      - 'ferie' → 'ferie_giornata_intera' or 'ferie_ore'
      - 'permesso' → 'permesso_giornata_intera' or 'permesso_ore'
      - 'malattia' → 'malattia'
    - Determine if it's full day or hourly based on time fields
    
  2. Why
    - The check constraint requires specific values
    - Need to distinguish between full-day and hourly absences
*/
...
-- Turni extra - USA EFFECTIVE_ORE_LAVORATE_MINUTI E "NoteTurno"
SELECT
