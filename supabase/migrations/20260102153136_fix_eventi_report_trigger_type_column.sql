/*
  # Fix Trigger Sync Eventi - Colonna tipo_evento → type
  
  ## Problema
  Il trigger sync_eventi_to_report() cerca la colonna "e.tipo_evento"
  ma nella tabella crew_events la colonna si chiama "type"
  
  ## Correzione
  Aggiorna la funzione sync_eventi_to_report() per usare "e.type"
  invece di "e.tipo_evento"
*/
...
BEGIN
  ...
  -- Recupera info evento (CORRETTO: title e type)
  SELECT 
    e.title,
    e.type,
    e.location
