/*
  # Fix column names in popola_dettaglio_giorno_semplice
  
  1. Changes
    - Use orario_inizio and orario_fine (not ora_inizio/ora_fine)
    
  2. Why
    - The actual column names in crew_richiesteferie_permessi are orario_*
*/
