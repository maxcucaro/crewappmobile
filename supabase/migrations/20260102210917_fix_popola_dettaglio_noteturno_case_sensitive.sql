/*
  # Fix column name case sensitivity for NoteTurno
  
  1. Changes
    - Use "NoteTurno" (quoted with proper case) instead of noteturno
    
  2. Why
    - PostgreSQL is case-sensitive for quoted column names
    - The column is named "NoteTurno" in the table
*/
